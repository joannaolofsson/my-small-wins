                ...
                <section className="w-lg flex flex-col mt-8 ">
                    <div>
                        {inputs.map((input, index) => (
                            <Link href="/smallwins" key={input.id || index}> 
                                <Card className='w-lg bg-white/30 border border-white/20 rounded-xl backdrop-blur-[15px] shadow-lg cursor-pointer my-4 flex flex-col gap-2 p-6'>
